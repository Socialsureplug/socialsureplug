...
<div class="container">
    ...
    <div class="card">
        <form action="{{ route('backend.payment-gateway.flutterwave.update') }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="card-body">
                <div class="row mb-25">
                    <div class="width-30">
                        <div class="gateway-qr-code">
                            ...
                            <div class="gateway-qr-code-image">
                                ...
                                <input type="file" name="flutterwave_image" id="gateway_qr_code_flutterwave" accept="image/*" style="display: none;">
                    ...
                    <div class="width-70">
                        <div class="row">
                            ...
                            <div class="form-group width-50">
                                ...
                                <input type="text" class="form-control" name="public_key" value="{{ old('public_key', $gateway->gateway_parameters->public_key ?? '') }}" placeholder="Enter public key">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group width-50">
                                <label class="form-label">Secret key<span class="required">*</span></label>
                                <input type="text" class="form-control" name="secret_key" value="{{ old('secret_key', $gateway->gateway_parameters->secret_key ?? '') }}" placeholder="Enter secret key">
                            </div>
                            <div class="form-group width-50">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="toggle-switch">
                                    ...
                                    <input type="checkbox" id="status_flutterwave" name="status" value="1" {{ ($gateway->status ?? 0) == 1 ? 'checked' : '' }}>
                                    <label for="status_flutterwave" class="toggle-label">
...
<script>
    (function() {
        ...
        const fileInput = document.getElementById('gateway_qr_code_flutterwave');
