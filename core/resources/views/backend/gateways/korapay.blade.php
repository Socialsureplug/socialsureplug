...
<div class="container">
    ...
    <div class="card">
        <form action="{{ route('backend.payment-gateway.korapay.update') }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="card-body">
                <div class="row mb-25">
                    <div class="width-30">
                        <div class="gateway-qr-code">
                            ...
                            <div class="gateway-qr-code-image">
                                ...
                                <input type="file" name="korapay_image" id="gateway_qr_code_korapay" accept="image/*" style="display: none;">
                    ...
                    <div class="width-70">
                        <div class="row">
                            ...
                            <div class="form-group width-50">
                                <label class="form-label">Public key<span class="required">*</span></label>
                                <input type="text" class="form-control" name="public_key" placeholder="pk_live_xxx or pk_test_xxx" value="{{ old('public_key', $gateway->gateway_parameters->public_key ?? '') }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group width-50">
                                <label class="form-label">Secret key<span class="required">*</span></label>
                                <input type="text" class="form-control" name="secret_key" placeholder="sk_live_xxx or sk_test_xxx" value="{{ old('secret_key', $gateway->gateway_parameters->secret_key ?? '') }}">
                            </div>
                            <div class="form-group width-50">
                                <label class="form-label">Webhook secret</label>
                                <input type="text" class="form-control" name="webhook_secret" placeholder="Optional, defaults to secret key" value="{{ old('webhook_secret', $gateway->gateway_parameters->webhook_secret ?? '') }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group width-50">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="toggle-switch">
                                    ...
                                    <input type="checkbox" id="status_korapay" name="status" value="1" {{ ($gateway->status ?? 0) == 1 ? 'checked' : '' }}>
                                    <label for="status_korapay" class="toggle-label">
...
<script>
    (function() {
        ...
        const fileInput = document.getElementById('gateway_qr_code_korapay');
