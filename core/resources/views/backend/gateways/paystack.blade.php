...
<div class="container">
    ...
    <div class="card">
        <form action="{{ route('backend.payment-gateway.paystack.update') }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="card-body">
                <div class="row mb-25">
                    <div class="width-30">
                        <div class="gateway-qr-code">
                            ...
                            <div class="gateway-qr-code-image">
                                ...
                                <input type="file" name="paystack_image" id="gateway_qr_code_paystack" accept="image/*" style="display: none;">
                    ...
                    <div class="width-70">
                        <div class="row">
                            ...
                            <div class="form-group width-50">
                                <label class="form-label">Paystack public key<span class="required">*</span></label>
                                <input type="text" class="form-control" name="paystack_public_key" placeholder="pk_live_xxx or pk_test_xxx" value="{{ old('paystack_public_key', $gateway->gateway_parameters->paystack_public_key ?? '') }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group width-50">
                                <label class="form-label">Paystack secret key<span class="required">*</span></label>
                                <input type="text" class="form-control" name="paystack_key" placeholder="sk_live_xxx or sk_test_xxx" value="{{ old('paystack_key', $gateway->gateway_parameters->paystack_key ?? '') }}">
                            </div>
                            <div class="form-group width-50">
                                <label class="form-label">Rate (1 {{ $gateway->gateway_parameters->gateway_currency ?? 'USD' }} = ?)<span class="required">*</span></label>
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="toggle-switch">
                                    ...
                                    <input type="checkbox" id="status_paystack" name="status" value="1" {{ ($gateway->status ?? 0) == 1 ? 'checked' : '' }}>
                                    <label for="status_paystack" class="toggle-label">
...
<script>
    (function() {
        ...
        const fileInput = document.getElementById('gateway_qr_code_paystack');
