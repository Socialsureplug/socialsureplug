...
<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('backend.rentings.settings.update') }}" method="POST" class="mb-25">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    <div class="form-group width-50">
                        ...
                        <input type="number" class="form-control" name="currency_rate" step="0.01" min="0"
                            ...
                            value="{{ old('currency_rate', $rentingSettings->currency_rate) }}" required>
                    </div>
                    <div class="form-group width-50">
                        ...
                        <input type="number" class="form-control" name="price_increase" step="0.01" min="0"
                            ...
                            value="{{ old('price_increase', $rentingSettings->price_increase) }}" required>
                    </div>
                </div>
