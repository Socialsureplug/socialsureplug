...
<div class="auth-page-wrapper">
    ...
    <div class="auth-card">
        <div class="auth-header">
            ...
            <p class="auth-subtitle">Enter the verification code sent to your email to continue.</p>
        </div>

        <form id="verifyForm" class="auth-form" method="POST" action="{{ route('user.verify-email.confirm') }}">
            @csrf
        ...
        <form id="resendVerificationForm" method="POST" action="{{ route('user.verify-email.resend') }}" style="display: none;">
            @csrf
        </form>
    </div>
</div>
