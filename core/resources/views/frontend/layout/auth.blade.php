...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/frontend/css/auth.css') }}?v={{ file_exists(base_path('../assets/frontend/css/auth.css')) ? filemtime(base_path('../assets/frontend/css/auth.css')) : time() }}">
    <style>
        :root {
...
<body>
    ...
    <script src="{{ asset('assets/frontend/js/auth.js') }}?v={{ file_exists(base_path('../assets/frontend/js/auth.js')) ? filemtime(base_path('../assets/frontend/js/auth.js')) : time() }}"></script>
